...
%
    ...
    \section{Bolometry at W7-X}\label{sec:w7xbolometer}%
%
...
%
                \begin{figure}
                    \centering%
                    \includegraphics[width=0.5\textwidth]{%
                        content/figures/chapter1/wheatstone_meas2.pdf}%
                ...
                \end{figure}
%
                Consider that $\Delta U$ the output voltage of the Wheatstone bridge is being measured in the equivalent circuit shown in \cref{fig:wheatstone_meas}. In accordance to \cref{eq:bolopower} the radiation power onto the measurement absorber can be expressed in $P\ix{bol}$. Adjusting \cref{eq:bolopower} to the details of the measurement circuit for absorber $M$ of the Wendelstein 7-X bolometer diagnostic, one arrives at the \tilt{bolometer equation}:%
%
                \begin{align}%
...
%
            \begin{figure}[t]%
                ...
                \begin{subfigure}{0.4\textwidth}%
                    \includegraphics[width=\textwidth]{%
                        content/figures/chapter1/lang_mast_photoresponse.pdf}%
...
%
            \begin{figure}[t]%
                ...
                \includegraphics[width=0.9\textwidth]{%
                    content/figures/chapter1/%
                    prad_example_20181010036_m.pdf}%
                \caption{%
                    XP20181010.36\\%
...
%
                \begin{empheq}[box=\fbox]{align}%
                    P_{\text{chord}, M}\coloneqq P_{\text{rad},M}\mathrel{\hat{=}}\frac{P_{M}}{\displaystyle\int_{M}L_{M}\,\diff\widetilde{K}_{M}}\overset{!}{=}\frac{P_{M}}{\sum_{i=0}^{N_{r}}\sum_{j=0}^{N_{\vartheta}}\sum_{k=0}^{N_{\varphi}}\varepsilon_{M}^{\left(i,j,k\right)}}\,\,.\label{eq:chord_profile}%
                \end{empheq}%
%
...
%
                \begin{empheq}[box=\fbox]{align}%
                    \mathrel{\hat{g}}\ix{rad}\left(r\right)&=\int_{0}^{2\pi}\mathrel{\hat{g}}\left(r,\vartheta\right)\diff\vartheta\,\,,\label{eq:radial_profile}\\%
                    \mathrel{\hat{g}}\ix{pol}\left(\vartheta\right)&=\int_{0}^{f\ix{P}r\ix{a}}\mathrel{\hat{g}}\left(r,\vartheta\right)\diff r\,\,.\label{eq:poloidal_profile}%
                \end{empheq}%
%
