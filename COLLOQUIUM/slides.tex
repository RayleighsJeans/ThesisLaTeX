...
\begin{frame}
    ...
    \begin{columns}
        \begin{column}{0.55\textwidth}
            \begin{itemize}
                \item World's largest stellarator (R$=$\SI{5.5}{\meter}, a$\sim$\SI{0.5}{\meter})
...
\begin{frame}
    ...
    \begin{columns}
        \begin{column}{0.5\textwidth}
            ...
            \begin{itemize}
                \item Time resolution: $\sim$\SI{1}{\milli\second}
...
\begin{frame}
    ...
    \begin{columns}
        \begin{column}{0.55\textwidth}
            ...
            \begin{itemize}
                ...
                \item Real-time capability validated
                \item Benchmark testing with laser diode
            \end{itemize}

            \vspace{1em}
            \textbf{Operational Experience:}
            \begin{itemize}
                \item Deployed during OP1.2b campaign
                \item Stable operation over multiple discharges
                \item Robust to plasma variations
            \end{itemize}
        \end{column}
    ...
    % TP: System latency of \SI{13.6}{\milli\second} is competitive but still limits performance compared to other diagnostics
    ...
    \begin{columns}
        \begin{column}{0.5\textwidth}
            ...
            \begin{itemize}
                ...
                \item Radiation fraction: $f\ix{rad} > 90\%$
                \item Peak values up to 100\%
                \item Target heat load reduction: factor of 2
                \item C$^{3+}$ detachment at $f\ix{rad} \sim 50\%$
    ...
    \begin{columns}
        \begin{column}{0.5\textwidth}
            ...
            \begin{itemize}
                ...
                \item Inward shift of radiation for $f\ix{rad} \rightarrow 1$
...
\begin{frame}
    ...
    \begin{columns}
        ...
        \begin{column}{0.45\textwidth}
            ...
            \begin{itemize}
                \item Tailored weighting: $k\ix{ani}(r)$
    ...
    \begin{columns}
        ...
        \begin{column}{0.45\textwidth}
            ...
            \begin{itemize}
                ...
                \item Reliable radiative cooling at $f\ix{rad}\ge$95\%
