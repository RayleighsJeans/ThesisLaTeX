...
\begin{frame}
    ...
    \begin{columns}
        \begin{column}{0.5\textwidth}
            ...
            \begin{itemize}
                \item Bremsstrahlung: $P\ix{Brems} \propto n_e^2 T^{1/2}$
...
\begin{frame}
    ...
    \begin{columns}[T]
        \begin{column}{0.55\textwidth}
            \textbf{Method:}
            \begin{itemize}
                \item Uses spectral correlation between $P\ix{\text{rad}}$ and $P\ix{\text{pred}}$
            ...
            \begin{align*}
                \gamma_i &= \mathcal{F}(P\ix{\text{rad}})(\omega) \\
                \gamma_j &= \mathcal{F}(P\ix{\text{pred}})(\omega) \\
...
\begin{frame}
    ...
    \begin{columns}[T]
        \begin{column}{0.48\textwidth}
            ...
            \begin{itemize}
                \item Weight: $\mathbf{W}\ix{RGS}=(1/g_i)^2$
