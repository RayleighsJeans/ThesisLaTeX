...
\item Vorhersage-$f_{rad}$ überschätzt 'tatsächlichen' Verlustwert konstant
...
\item \textbf{KLICK}
\item Statistik: Beispielhafte Ergebnisse für nur $k_{edge}$ Variation. Klares Maximum in Pearson nicht kongruent mit $\chi$/MSD
...
\begin{itemize}
  \item Zur Veranschaulichung der gewonnen Erkenntnisse und Erfahrung ein eperimentelles, praktisches Beispiel
  ...
  \item \textbf{KLICK}
  \item Mit Erfahrung aus Phantomen qualitativ und quantitativ erfolgreiche, verlässliche Rekonstruktionen
  \item \textbf{KLICK}
  \item Statistik wie bei Phantomen: nur Leistungen als Parameter zur Verfügung - Diskrepanz P$_{rad}$ vs P$_{2D}$ reproduziert mit SOL/Kern Korrelationen bis auf die genauen Werte
