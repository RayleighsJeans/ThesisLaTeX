...
\begin{itemize}
\item Ziel: 2D-Strahlungsverteilung $P_{rad}$ (R,Z) aus 1D-Linienintegrierten-Helligkeitsmessungen rekonstruieren
...
\item Anisotropie-Gewichtung: $k_{ani}$ ($\rho$) variiert radial - {2,0, 0,3} Standard (Kern anisotrop, Rand isotrop), {5,0, 0,5} hochanisotrop (starke Flussflächenausrichtung)
