...
\begin{itemize}
\item (1) Motivation - Fusionsenergie und W7-X-Herausforderungen
\item (2) Bolometer-Diagnostiksystem - 94 Kanäle mit $\sim $ 5cm räumlicher Auflösung
\item (3) Echtzeit-Feedback - erreichte $ f_{rad} \geq $ 85\% mit Faktor $\geq $ 2 Wärmelast-Reduktion 
\item (4) LOS-Sensitivität - identifizierte optimale Kanalkonfigurationen
\item (5) Tomographie - MFR mit RDA für 2D-Strahlungsrekonstruktion
\item (6) Schlussfolgerungen und zukünftige Arbeiten
\end{itemize}
