...
\begin{document}
	...
	{\bfseries \color{familynamecolor}%
		...
		reference number 171/17-8.2
	}\\[0.75cm]
%
	Dear Mrs.\ or Mr.,\\[0.5cm]
%	
	with this form I would like to submit my initial application for the Ph.D. position referenced under 171/17-8.2 at the Bundesanstalt für Materialforschung und -prüfung - Fachbereich “Zerstörungsfreie Schadensdiagnose und Umweltmessverfahren” in Berlin-Steglitz.\\[0.3cm]
%
